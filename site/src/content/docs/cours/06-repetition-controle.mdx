...
<Aside type='tip' title='Comment choisir?'>
- Quand le nombre de répétitions est connu d'avance, `for` est souvent plus naturel.  
- Quand la répétition dépend surtout d'une condition, `while` est souvent plus appropriée.
</Aside>

| Situation | Boucle la plus naturelle |
|---|---|
